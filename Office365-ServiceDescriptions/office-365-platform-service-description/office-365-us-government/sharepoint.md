...
In questo articolo viene fornita una panoramica delle differenze di funzionalità tra il cloud governativo statunitense e il cloud [commerciale, come](../../sharepoint-online-service-description/sharepoint-online-service-description.md)indicato nella descrizione SharePoint servizio. SharePoint è disponibile per gli ambienti Government Community Cloud (GCC), GCC High e DoD. 
...
- Graph funzionalità in SharePoint Online per GCC High è attualmente disabilitata. Qualsiasi servizio che si basa su Microsoft Graph potrebbe non essere attualmente disponibile
...
Dopo aver configurato l'organizzazione nel cloud di Microsoft US Government, seguire il percorso di distribuzione consigliato descritto nel Centro risorse per l'adozione di [SharePoint.](https://resources.techcommunity.microsoft.com/resources/SharePoint-adoption/) Assicurati di interagire con i tuoi campioni di adozione e gestione delle modifiche.
...
6. Avviare di nuovo la procedura guidata SharePoint configurazione ibrida.
