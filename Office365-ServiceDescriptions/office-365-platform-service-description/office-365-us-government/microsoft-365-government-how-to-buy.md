...
Microsoft 365 Government è un insieme di funzionalità software cloud di produttività, sicurezza e mobilità personalizzate per le agenzie governative e gli appaltatori statunitensi sponsorizzati per contenere informazioni controllate e non classificate. Fornito attraverso ambienti univoci che soddisfano i requisiti di conformità più stringenti, Microsoft 365 Government è un'offerta cloud per i clienti del governo statunitense che corrisponde il più possibile alle funzionalità e alle funzionalità delle offerte aziendali cloud commerciali Microsoft.
...
## <a name="what-makes-microsoft-365-government-different-from-microsoft-365-for-enterprise-offerings"></a>Cosa rende Microsoft 365 governo diverso dalle Microsoft 365 per le offerte aziendali?
...
**Archiviazione del contenuto.** I dati vengono archiviati negli Stati Uniti continentali con un'infrastruttura conforme. Nella tabella seguente sono riepilogati Microsoft 365 per gli impegni e gli ambienti governativi.<br><br>
...
- Entità tribale, definita come entità tribale riconosciuta a livello federale e idonea per i fondi e i servizi del Dipartimento degli Interni degli Stati Uniti in virtù del suo status di una tribù indiana o, in Alaska, di un paese nativo o di un'azienda nativa dell'Alaska

Le organizzazioni non governative che contengono i seguenti tipi di dati e possono fornire le prove elencate sono idonee per il processo di convalida di Microsoft Government Cloud:
...
- [Outlook per iOS e Android nella Government Community Cloud](/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/outlook-for-ios-and-android-in-the-government-cloud)
...
Segui questa procedura per acquistare licenze Microsoft 365 per enti pubblici:
...
- [Office 365.](https://aka.ms/gcctrial) Una versione di valutazione gratuita di un mese è disponibile solo GCC versione di valutazione.  
- Microsoft non offre versioni di valutazione Office 365 GCC clienti commerciali e non sono disponibili versioni di valutazione di GCC High o DoD.
