...
|Office 365 Enterprise E5 senza servizi di audioconferenza  <br/> | Skype for Business online Piano autonomo 2 incluso (per informazioni sulle funzionalità incluse, vedere Skype for Business online Piano autonomo 2 sopra riportato).  <br/>  Sistema telefonico incluso.  <br/> > [!NOTE]> se acquistato da solo senza piani di chiamata, il sistema telefonico Abilita solo la funzionalità di segreteria telefonica ibrida. Hybrid Voice richiede una distribuzione delle funzionalità vocali ibrida in locale per abilitare le chiamate PSTN usando il provider di servizi PSTN esistente. Per abilitare le chiamate PSTN in ingresso e in uscita utilizzando Microsoft come provider di servizi PSTN, sono disponibili i seguenti componenti aggiuntivi del sistema telefonico: > nazionale (disponibile solo in alcuni paesi). piano per le chiamate internazionali di > (disponibile solo in alcuni paesi).           |
