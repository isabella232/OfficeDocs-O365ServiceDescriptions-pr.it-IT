...
Skype for Business è ospitato su server multi-tenant che supportano più utenti in contemporanea. Tali server risiedono nei data center di Microsoft e sono accessibili da parte degli utenti con un'ampia gamma di dispositivi dall'interno di una rete aziendale o da Internet. 
...
|[Piano](http://technet.microsoft.com/library/cf1a3734-3b82-4f63-b390-f14b91ce1a0e.aspx) per le chiamate (Piano per le chiamate nazionali, con acquisto di componenti aggiuntivi necessari)  <br/> |No  <br/> |No  <br/> |No  <br/> |Sì<sup>3</sup> <br/> |Sì<sup>3</sup> <br/> |Sì  <br/> |No  <br/> |
|[Piano](http://technet.microsoft.com/library/cf1a3734-3b82-4f63-b390-f14b91ce1a0e.aspx) per le chiamate (Piano di chiamata internazionale, con acquisto di componenti aggiuntivi necessari)  <br/> |No  <br/> |No  <br/> |No  <br/> |Sì<sup>3</sup> <br/> |Sì<sup>3</sup> <br/> |Sì  <br/> |No  <br/> |
...
|Office 365 Enterprise E5 con servizi di audioconferenza  <br/> | Skype for Business online Piano autonomo 2 incluso (per informazioni sulle funzionalità incluse, vedere Skype for Business online Piano autonomo 2 sopra riportato)  <br/>  È inclusa la funzionalità di audioconferenza.  <br/>  Sistema telefonico incluso.  <br/> > [!NOTE]> se acquistato da solo senza piani di chiamata, il sistema telefonico Abilita solo la funzionalità di segreteria telefonica ibrida. Hybrid Voice richiede una distribuzione delle funzionalità vocali ibrida in locale per abilitare le chiamate PSTN tramite il provider di servizi PSTN esistente. Per abilitare le chiamate PSTN in ingresso e in uscita utilizzando Microsoft come provider di servizi PSTN, sono disponibili i seguenti componenti aggiuntivi del sistema telefonico: > piano per le chiamate nazionali (disponibile solo in alcuni paesi). > piano per le chiamate internazionali (disponibile solo in alcuni paesi).           |
|Office 365 Enterprise E5 senza servizi di audioconferenza  <br/> | Skype for Business online Piano autonomo 2 incluso (per informazioni sulle funzionalità incluse, vedere Skype for Business online Piano autonomo 2 sopra riportato).  <br/>  Sistema telefonico incluso.  <br/> > [!NOTE]> se acquistato da solo senza piani di chiamata, il sistema telefonico Abilita solo la funzionalità di segreteria telefonica ibrida. Hybrid Voice richiede una distribuzione delle funzionalità vocali ibrida in locale per abilitare le chiamate PSTN usando il provider di servizi PSTN esistente. Per abilitare le chiamate PSTN in ingresso e in uscita utilizzando Microsoft come provider di servizi PSTN, sono disponibili i seguenti componenti aggiuntivi del sistema telefonico: > piano per le chiamate nazionali (disponibile solo in alcuni paesi). > piano per le chiamate internazionali (disponibile solo in alcuni paesi).           |
