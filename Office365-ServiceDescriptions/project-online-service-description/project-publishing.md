...
SharePoint e Skype per le caratteristiche di interoperabilità seguenti sono disponibili in Project Online.
...
## <a name="create-a-project-site"></a>Creazione di un sito in Project
...
## <a name="publish-projects-to-project-server-or-project-online"></a>Pubblicazione dei progetti su Project Server o Project Online
...
## <a name="save-a-project-mpp-file-to-sharepoint"></a>Salvataggio di un file di progetto MPP su SharePoint
...
## <a name="task-list-sync-to-sharepoint"></a>Sincronizzazione dell'elenco attività di SharePoint
