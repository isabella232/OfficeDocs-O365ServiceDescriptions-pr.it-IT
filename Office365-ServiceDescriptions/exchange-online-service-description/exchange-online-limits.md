...
- [Limiti della rubrica](#abl.md)
    
- [Limiti di archiviazione delle cassette postali](#StorageLimits.md)
    
- [Avvisi di capacità](#CapacityAlerts.md)
    
- [Limiti cartella delle cassette postali](exchange-online-limits.md#MailboxFolderLimits)
    
- [Limiti dei messaggi](#MessageLimits.md)
    
- [Limiti di invio e ricezione](#RecipientLimits.md)
    
- [Limiti relativi alla creazione di rapporti e traccia dei messaggi](exchange-online-limits.md#reporting-and-message-trace-limits)
    
- [Limiti di conservazione](#RetentionLimits.md)
    
- [Limiti dei gruppi di distribuzione](#DistributionGroupLimits.md)
    
- [Limiti del delle regole di journal, trasporto e Posta in arrivo ](#TransportRuleLimits.md)
    
- [Limiti di moderazione](#ModerationLimits.md)
    
- [Limiti di Exchange ActiveSync](exchange-online-limits.md#exchange-activesync-limits)
...
|Cassette postali di archiviazione<sup>7, 8</sup> <br/> |50 GB  <br/> |50 GB  <br/> |50 GB  <br/> |Unlimited<sup>1</sup> <br/> |Illimitato<sup>1</sup> <br/> |Non disponibile<sup>4</sup> <br/> |
...
> [!NOTE]
> <sup>1</sup> Questo è il limite predefinito per le organizzazioni Exchange Server 2013. Gli amministratori possono modificare questo valore per l'organizzazione. > <sup>2</sup> Questo limite si applica anche agli amministratori. 
