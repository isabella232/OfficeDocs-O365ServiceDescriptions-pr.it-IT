...
Microsoft 365 Business Premium è una soluzione integrata che riunisce la migliore produttività di Microsoft 365 con sicurezza avanzata e gestione dei dispositivi per proteggere l'azienda dalle minacce avanzate. La descrizione di questo servizio delinea le opzioni e le caratteristiche del piano. Per ulteriori informazioni su Office 365, vedere le descrizioni dei servizi di [Microsoft 365 e Office 365.](../office-365-service-descriptions-technet-library.md)
  
## <a name="feature-availability-across-microsoft-365-business-standard-and-microsoft-365-business-premium-plans"></a>Disponibilità delle funzionalità tra i piani Microsoft 365 Business Standard e Microsoft 365 Business Premium

Microsoft 365 Business Premium include essenzialmente tutte le funzionalità disponibili in Microsoft 365 Business Standard insieme ad altre funzionalità di sicurezza di Microsoft.<br><br>

| Opzioni dei piani | Microsoft 365 Business Standard | Microsoft 365 Business Premium |
|:-----|:-----|:-----|
|Piattaforma Office 365  <br/> |Sì  <br/> |Sì  <br/> |
...
|[Amministrazione di Microsoft 365](https://docs.microsoft.com/office365/admin/admin-overview/about-the-admin-center#admin-center-features-and-settings) <br/> |**Microsoft 365 Business Standard** <br/> |**Microsoft 365 Business Premium** <br/> |
...
|Archiviazione sul posto e conservazione per controversia legale  <br/> |No  <br/> |Sì<sup>3</sup>  <br/> |
|eDiscovery sul posto  <br/> |Sì  <br/> |Sì  <br/> |
|Transport rules  <br/> |Sì  <br/> |Sì  <br/> |
...
|**Azure AD Premium P1 è disponibile per i clienti di Microsoft 365 Business Premium.**<br/>|**Microsoft 365 Business Standard** <br/> |**Microsoft 365 Business Premium** <br/> |**Enterprise Mobility + Security E3** <br/> |
...
|Gruppi dinamici  <br/> |No  <br/> |Sì  <br/> |Sì  <br/> |
|Reimpostazione della password in modalità self-service per le identità cloud  <br/> |Sì  <br/> |Sì  <br/> |Sì  <br/> |
|Reimpostazione della password in modalità self-service con write-back AD locale  <br/> |No  <br/> |Sì<sup>9</sup>  <br/> |Sì  <br/> |
|Sincronizzazione bidirezionale di oggetti dispositivo tra directory locali e Azure AD (write-back dispositivo)  <br/> |No  <br/> |Sì<sup>9</sup>  <br/> |Sì  <br/> |
|Accesso condizionale (in base al gruppo, alla posizione o allo stato del dispositivo)  <br/> |No  <br/> |Sì<sup>9</sup>  <br/> |Sì  <br/> |
|Personalizzazione della società (pagine di accesso/personalizzazione del pannello di accesso)  <br/> |Sì  <br/> |Sì  <br/> |Sì  <br/> |
|Proxy dell'applicazione  <br/> |No  <br/> |Sì<sup>9</sup>  <br/> |Sì  <br/> |
...
|[Gestione di dispositivi e applicazioni](https://docs.microsoft.com/intune/fundamentals/what-is-device-management)<br/> Microsoft 365 Business Premium include funzionalità complete di Intune per iOS, Android, Mac OS e altre funzionalità di gestione dei dispositivi multipiattaforma. <sup>8</sup> <br/> |**Microsoft 365 Business Standard** <br/> |**Microsoft 365 Business Premium** <br/> |
|Gestione di dispositivi mobili (MDM) di Intune per PC, Mac e dispositivi mobili<sup>5</sup> <br/> |No  <br/> |Sì  <br/> |
|Registrazione automatica di Gestione di dispositivi mobili (MDM)  <br/> |No  <br/> |Sì  <br/> |
|Intune Mobile Application Management (MAM) per app di Office e app LOB<br/> |No  <br/> |Sì  <br/> |
|Gestione degli aggiornamenti di Windows, Defender, criteri firewall<sup>5</sup> <br/> |No  <br/> |Sì  <br/> |
|Protezione dei dati: cancellazione selettiva  <br/> |Sì  <br/> |Sì  <br/> |
|Destinazione del gruppo di sicurezza (SG) per i criteri  <br/> |No  <br/> |Sì  <br/> |
...
|Distribuzione dei profili di dispositivo e della configurazione della sicurezza<sup>5</sup> <br/> |No  <br/> |Sì  <br/> |
...
|**Gestione di Windows 10 Pro** <br/>Se si dispone di dispositivi con licenza per Windows 7 e 8.1 Professional, Microsoft 365 Business Premium fornisce un aggiornamento a Windows 10 Pro.<sup>9</sup> <br/>|**Microsoft 365 Business Premium** <br/> |
...
|Controllo dell'organizzazione dell'accesso degli utenti alle app da Microsoft Store  <br/> |Sì  <br/> |
|Controllo dell'organizzazione dell'accesso degli utenti a Cortana  <br/> |Sì  <br/> |
|Controllo organizzativo dei suggerimenti e delle pubblicità di Windows di Microsoft  <br/> |Sì  <br/> |
|Aggiornamento automatico dei dispositivi Windows 10  <br/> |Sì  <br/> |
|**Sicurezza di Windows 10** <br/> |**Microsoft 365 Business Premium** <br/> |
|Proteggere i PC da virus e altre minacce tramite Windows Defender Antivirus  <br/> |Sì  <br/> |
|Proteggere i PC dalle minacce basate sul Web in Microsoft Edge  <br/> |Sì  <br/> |
...
|Proteggere file e cartelle nei PC da accessi non autorizzati con BitLocker <br/> |Sì  <br/> |
...
<sup>3</sup> Microsoft 365 Business Premium include Archiviazione Exchange Online abbonamento. Inizialmente, ogni sottoscrittore di Archiviazione Exchange Online riceve 100 GB di spazio nella cassetta postale di archiviazione. Quando si attiva l'archiviazione con espansione automatica, viene aggiunta ulteriore memoria al raggiungimento della capacità massima di 100 GB. Per ulteriori informazioni, vedere [Panoramica dell'archiviazione illimitata.](https://docs.microsoft.com/office365/securitycompliance/unlimited-archiving) <br/>
...
<sup>5</sup> Gestione semplificata dei dispositivi Windows 10 integrata nell'interfaccia di amministrazione di Microsoft 365. Funzionalità di gestione intune di iOS, Android, macOS e altre funzionalità di gestione dei dispositivi multipiattaforma integrate nell'interfaccia di amministrazione di Gestione dispositivi, con licenza per l'uso con Microsoft 365 Business Premium. Le app di terze parti e la configurazione di elementi come profili WiFi e certificati VPN possono essere gestiti anche nell'interfaccia di amministrazione di Gestione dispositivi. <br/>
<sup>6</sup> Questo piano viene fornito con Microsoft Stream Piano 2, che include il portale video, la trascrizione della sintesi vocale, la ricerca approfondita e il rilevamento dei volto.<br/>
