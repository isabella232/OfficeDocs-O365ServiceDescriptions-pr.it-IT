...
|[Gestione di identità e accesso](https://docs.microsoft.com/microsoft-365/business/security-features)<br/> La versione completa di Azure AD Premium P1 è prossima ai clienti aziendali Microsoft 365. Per ulteriori informazioni, vedere [questo post di Blog](https://aka.ms/aadp1smbblog). <sup>8</sup> <br/>|**Office 365 Business Premium** <br/> |**Microsoft 365 Business** <br/> |**Enterprise Mobility + Security E3** <br/> |
|Autenticazione a più fattori di Azure (AMF)  <br/> |No  <br/> |Sì<sup>11</sup>  <br/> |Sì  <br/> |
...
|Reimpostazione della password in modalità self-service con write-back AD locale  <br/> |No  <br/> |Sì<sup>11</sup>  <br/> |Sì  <br/> |
|Sincronizzazione bidirezionale di oggetti dispositivo tra directory locali e Azure AD (write-back dispositivo)  <br/> |No  <br/> |Sì<sup>11</sup>  <br/> |Sì  <br/> |
|Accesso condizionale (in base al gruppo, alla posizione o allo stato del dispositivo)  <br/> |No  <br/> |Sì<sup>11</sup>  <br/> |Sì  <br/> |
|Branding aziendale (pagine di accesso/personalizzazione del riquadro di accesso)  <br/> |Sì  <br/> |Sì  <br/> |Sì  <br/> |
|Proxy di applicazione  <br/> |No  <br/> |Sì<sup>11</sup>  <br/> |Sì  <br/> |
|User CAL (Licenza di accesso da parte dell'utente) di Microsoft Identity Manager (MIM)  <br/> |No  <br/> |Sì<sup>11</sup>  <br/> |Sì  <br/> |
|Connect Health  <br/> |No  <br/> |Sì<sup>11</sup>  <br/> |Sì  <br/> |
...
|||
|:-----|:-----|
|**Gestione di Windows 10 Pro** <br/>Se si dispone di dispositivi concessi in licenza per Windows 7 e 8,1 Professional, Microsoft 365 business fornisce un aggiornamento a Windows 10 Pro. <sup>10</sup> <br/>|**Microsoft 365 Business** <br/> |
