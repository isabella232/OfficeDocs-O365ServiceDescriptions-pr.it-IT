...
|[Gestione di identità e accesso](https://docs.microsoft.com/microsoft-365/business/security-features)<br/> La versione completa di Azure AD Premium P1 è prossima ai clienti aziendali Microsoft 365. Per ulteriori informazioni, vedere [questo post di Blog](https://aka.ms/aadp1smbblog).<br/>|**Office 365 Business Premium** <br/> |**Microsoft 365 Business** <br/> |**Enterprise Mobility + Security E3** <br/> |
|Azure Multi-Factor Authentication (MFA)  <br/> |No  <br/> |Sì<sup>10</sup>  <br/> |Sì  <br/> |
|Unità amministrative  <br/> |No  <br/> |Sì<sup>10</sup>  <br/> |Sì  <br/> |
|Individuazione di app per cloud  <br/> |No  <br/> |Sì<sup>10</sup>  <br/> |Sì  <br/> |
|Gruppi dinamici  <br/> |No  <br/> |Sì<sup>10</sup>  <br/> |Sì  <br/> |
...
|||
|:-----|:-----|
|**Gestione di Windows 10 Pro** <br/>Se si dispone di dispositivi concessi in licenza per Windows 7 e 8,1 Professional, Microsoft 365 business fornisce un aggiornamento a Windows 10 Pro. <sup>9</sup> <br/>|**Microsoft 365 Business** <br/> |
...
|**Sicurezza di Windows 10** <br/> |**Microsoft 365 Business** <br/> |
...
<sup>7</sup> Microsoft 365 viene fornito con Office 365 Advanced Threat Protection Plan 1. Per ulteriori informazioni, vedere [Microsoft 365 Business Security and Compliance features](https://docs.microsoft.com/microsoft-365/business/security-features).<br/>
...
<sup>9</sup> se si dispone di dispositivi concessi in licenza per Windows 7 e 8,1 Professional, Microsoft 365 business fornisce un aggiornamento a Windows 10 Pro. Con Microsoft 365 business non si ottengono solo le [funzionalità di sicurezza di Microsoft Defender che vengono abilitate in Windows Pro](https://go.microsoft.com/fwlink/p/?linkid=2089903), si ottiene anche l'accesso alle funzionalità Premium come la protezione di rete per le minacce basate sul Web e le regole Host Intrusion Prevention per attenuare il ransomware. Quando si configura il tenant aziendale di Microsoft 365, si seleziona la protezione delle app e le impostazioni di configurazione dei dispositivi. Tali impostazioni definiscono i criteri che vengono applicati automaticamente ai dispositivi che accedono ad Azure Active Directory.</br>
<sup>10</sup> la versione completa di Azure ad Premium P1 è prossima ai clienti aziendali Microsoft 365. Per ulteriori informazioni, vedere [questo post di Blog](https://aka.ms/aadp1smbblog).
