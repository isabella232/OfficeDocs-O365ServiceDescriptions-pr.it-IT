...
> [!NOTE]
> Se l'organizzazione ha già soddisfatto i requisiti di idoneità di Microsoft 365 Government – DoD ed è stata richiesta e accettata nel programma, è possibile ignorare i passaggi 1 e 2 e andare direttamente al passaggio 3.
...
- *Decidi se Microsoft 365 Government - DoD è appropriato per la tua organizzazione.*
...
| | Classificazione ed etichettatura automatiche per Office app (Word, Excel, PowerPoint, Outlook) tra piattaforme (Web, Windows e Mac)  | Disponibile  |
...
| | Insider Risk Management: supportare i trigger nativi per l Azure Active Directory'eliminazione dell'account | Anteprima pubblica  |
