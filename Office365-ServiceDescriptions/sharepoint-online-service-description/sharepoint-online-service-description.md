...
Per sincronizzare SharePoint file in un computer, gli utenti possono usare [l'app](https://support.office.com/article/sync-sharepoint-and-teams-files-with-the-onedrive-sync-app-6de9ede8-5b6e-4503-80b2-6190f3354a88) OneDrive per Windows o Mac. Per info sulla disponibilità delle funzionalità nell'app di sincronizzazione, vedi la [descrizione OneDrive servizio di sincronizzazione.](../onedrive-for-business-service-description.md) 
...
- Office per l'integrazione Web. Richiede una sottoscrizione che include Office 365.
