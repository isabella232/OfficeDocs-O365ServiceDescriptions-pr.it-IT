...
<br/>
<sup>2</sup> Il piano Exchange Online Piano 1 e Microsoft 365 Apps hanno un limite di dimensione per la cassetta postale e l'archivio. Per ulteriori informazioni, vedere [Limiti di Exchange Online.](../exchange-online-service-description/exchange-online-limits.md) Archiviazione Exchange Online per Exchange Online aggiunge un archivio illimitato basato sul cloud e il [Archiviazione sul posto e conservazione per controversia legale](compliance-and-security-features.md#in-place-hold-and-litigation-hold).
